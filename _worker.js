			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						newHeaders.set('cf-connecting-ip', '1');
						newHeaders.set('x-forwarded-for', '1');
						newHeaders.set('x-real-ip', '1');
...
const cn_hostnames = [
	...
	'www.speedtest.net',        // Speedtest - A speed internet
